...
namespace QuanLyGiaiDau.Controllers
{
    ...
    public class DoiDausController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdTranDau,TenDoiDau,Logo")] DoiDau doiDau)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("IdTranDau,TenDoiDau,Logo")] DoiDau doiDau)
        {
            if (id != doiDau.IdTranDau)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!DoiDauExists(doiDau.IdTranDau))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.DoiDaus.Any(e => e.IdTranDau == id);
        }
    }
}
